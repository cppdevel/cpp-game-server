...
size_t Provider::ItemsCount() const { return items.size(); }

Item Provider::GetItem(size_t idx) const { return items.at(idx); }

size_t Provider::GatherersCount() const { return gatherers.size(); }

Gatherer Provider::GetGatherer(size_t idx) const { return gatherers.at(idx); }
